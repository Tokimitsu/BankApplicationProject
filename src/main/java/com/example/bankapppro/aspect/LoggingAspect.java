package com.example.bankapppro.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.example.bankapppro.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.example.bankapppro.service.*.*(..))")
